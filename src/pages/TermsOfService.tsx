    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl relative z-10">
        <div className="glass-panel border-none rounded-xl p-8 md:p-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Terms & <span className="text-gold">Conditions</span></h1>
          ...
          <section className="space-y-6 text-muted-foreground">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">2. Use License</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">2.1 Permission is Granted To:</h3>
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">2.2 You Must Not:</h3>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">3.2 Account Types</h3>
              <ul className="list-disc ml-6 space-y-2">
                <li><strong className="text-white">Customer Accounts</strong>: For users who book salon services</li>
                <li><strong className="text-white">Salon Owner Accounts</strong>: For businesses offering salon services</li>
              </ul>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">4. Bookings and Appointments</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.1 Customer Responsibilities</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <div className="bg-primary/10 border-l-4 border-primary p-4 rounded-r-lg my-6">
                <p className="text-white font-semibold">Important: Slixo is a platform that connects customers with salons. We do not provide beauty services directly. All services are provided by independent salon businesses.</p>
              </div>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.2 Salon Owner Responsibilities</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">4.3 Cancellation Policy</h3>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">5. Reviews and Ratings</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">5.1 User-Generated Content</h3>
              <p className="mb-3">When you post reviews, ratings, or photos:</p>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">5.2 Content Moderation</h3>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">6. Gamification and Rewards</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.1 Streak System</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.2 Points and Benefits</h3>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">7. Payment and Fees</h2>

              <div className="bg-primary/10 border-l-4 border-primary p-4 rounded-r-lg mb-4">
                <p className="text-white font-semibold">Important: Slixo does NOT process payments for salon services. All payments are handled directly between customers and salons.</p>
              </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">8. Privacy and Data Protection</h2>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">8.1 Data We Collect</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">8.2 Your Rights</h3>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">9. Disclaimer of Warranties</h2>
              <p className="mb-3">THE APP IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:</p>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              ...
              <p className="mb-3">Slixo and its affiliates SHALL NOT BE LIABLE FOR:</p>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <div className="bg-primary/10 border-l-4 border-primary p-4 rounded-r-lg mt-6">
                <p className="text-white font-semibold">Platform Role: Slixo is a technology platform that facilitates connections between customers and salons. We are not responsible for the services provided by salon businesses.</p>
              </div>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">11. Intellectual Property</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.1 Our Property</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.2 Your Content</h3>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">12. Termination</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">12.1 Your Right to Terminate</h3>
              <ul className="list-disc ml-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">12.2 Our Right to Terminate</h3>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">13. Governing Law</h2>
              <p>
            ...
            <div>
              ...
              <p className="mb-3">We reserve the right to modify these Terms at any time. We will notify you of changes by:</p>
              <ul className="list-disc ml-6 space-y-2">
                <li>Updating the "Last Updated" date</li>
                <li>Posting a notice in the App</li>
                <li>Sending an email notification (for significant changes)</li>
              </ul>
              <p className="mt-3">Your continued use of the App after changes constitutes acceptance of the updated Terms.</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">15. Contact Information</h2>

              <div className="bg-white/5 p-6 rounded-lg border border-white/5">
                <p className="mb-3">If you have questions about these Terms & Conditions, please contact us:</p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">16. Severability</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4 mt-8">17. Entire Agreement</h2>
              <p>
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              <p className="text-white mb-2"><strong>Terms & Conditions Version</strong>: 1.0</p>
